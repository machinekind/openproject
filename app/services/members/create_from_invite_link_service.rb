...
module Members
  class CreateFromInviteLinkService
    attr_reader :invite_link, :user
    ...
    def existing_member
      ...
      @existing_member = project.memberships.find_by(user_id: user.id, entity_id: nil, entity_type: nil)
    end

    def add_role_to_existing_member
